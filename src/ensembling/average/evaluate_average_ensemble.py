...
from common.soft_predictions import load_soft_predictions
...
if __name__ == "__main__":
    ...
    # Load best weights
    best_weights = np.load(os.environ.get(
        "GA_WEIGHTS_PATH",
        "results/ga_artifacts/best_weights_genetic_algorithm_ensemble_100gen_simple.npy"))
