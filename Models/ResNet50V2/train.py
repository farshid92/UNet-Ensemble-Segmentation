...
from model import build_resnet50v2_unet
...
if __name__ == "__main__":
    ...
    lr = 1e-5
    num_epoch = 50
    model_path = "files/model_resnet50v2.keras"
    csv_path = "files/data_resnet50v2.csv"
    log_dir = "files/logs_resnet50v2"
    ...
    """ Model """
    model = build_resnet50v2_unet((256, 256, 3))
    metrics = [
        dice_coef, 
        iou, 
