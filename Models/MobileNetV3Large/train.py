...
from model import build_unet_mobilenetv3
...
if __name__ == "__main__":
    ...
    lr = 1e-5
    num_epoch = 50
    model_path = "files/model_mobilenetv3large.keras"
    csv_path = "files/data_mobilenetv3large.csv"
    log_dir = "files/logs_mobilenetv3large"
    ...
    if len(valid_x)%batch_size !=0:
        ...
        """ Model """
    model = build_unet_mobilenetv3((H, W, 3))
    metrics = [dice_coef, 
               iou, 
